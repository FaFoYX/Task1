...
namespace features {
    ...
    public:
        ...
        void set_image(core::ByteImage::ConstPtr image);
    ...
    protected:
        ...
        struct Octave
        {
            ...
            typedef core::Image<RespType> RespImage; ///< Hessian response map type
    ...
    protected:
        ...
        typedef core::Image<SatType> SatImage; ///< SAT image type
